(function(a) {
    a.flexslider = function(c, b) {
        ...
        d.init = function() {
            ...
            if (d.vars.directionsContainer != "") {
                d.directionsContainer = a(d.vars.directionsContainer).eq(a(".slides").index(d.container));
                d.directionsContainerExists = d.directionsContainer.length > 0
            }
            ...
            if (d.vars.controlNav) {
                ...
                function(i) {
                    ...
                    if (!a(this).hasClass("active")) {
                        d.flexAnimate(d.controlNav.index(a(this))-3, d.vars.pauseOnAction);
                    }
                })
            }
            if (d.vars.directionNav) {
                ...
                if (d.directionsContainerExists) {
                    a(d.directionsContainer).append(f);
                    d.directionNav = a(".flex-direction-nav li a", d.directionsContainer)
                } else {
                    d.append(f);
...
$(document).ready(function(){
	...
	$(".tu>a").css('width',kuan);
	$(".xu:eq(0)").css('backgroundImage','url(yi_haitao_files/images_v2/imagefen.png)');

	function huan()
	{	
		$(".xu:eq("+i+")").css('backgroundImage','url(yi_haitao_files/images_v2/imagefen.png)');
		$(".xu:eq("+i+")").siblings().css('backgroundImage','url(yi_haitao_files/images_v2/imagehei.png)');
	...
	$("#hao").find(".xu").click(function(){
		j=$(this).index();
		$(".xu:eq("+j+")").css('backgroundImage','url(yi_haitao_files/images_v2/imagefen.png)');
		$(".xu:eq("+j+")").siblings().css('backgroundImage','url(yi_haitao_files/images_v2/imagehei.png)');
