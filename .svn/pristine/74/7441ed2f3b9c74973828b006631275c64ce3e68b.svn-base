...
<script type="text/javascript">
	...
	function form_check(){
		...
		if(account_logo_val==''){
			layer_tip(account_logo,'请选择帐号logo！');
			return false;
		}
		if(!is_img(account_logo_val)){
...
<div class="content_main">
	...
	<div class="web_content">
		<div class="content_info">
			<form action="do.php?act=weixin_account_add" method="post" onsubmit="return form_check()" enctype="multipart/form-data">
				...
				<table cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="right_td">
							<input type="text" id="platform_id" name="platform_id" maxlength="15" class="data_text"/>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="right_td">
							<input type="text" id="account_name" name="account_name" class="data_text"/>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="right_td">
							<input type="text" id="app_id" name="app_id" maxlength="18" class="data_text"/>
					...
					<tr>
						...
						<td class="right_td">
							<input type="text" id="app_secret" name="app_secret" maxlength="32" style="width:300px;" class="data_text"/>
						</td>
					</tr>
					<tr>
						<td class="left_td">EncodingAesKey：</td>
						<td class="right_td">
							<input type="text" id="encoding_aes_key" name="encoding_aes_key" maxlength="43" style="width:360px;" class="data_text"/>
