...
//获取管理员信息
$admin_sql = "select group_id,admin_name,email from admins where admin_id=$aid limit 1";
$admin_arr = $mysql_handle->getRow($admin_sql);
if($admin_arr==false){
	admin_tip(0, '获取管理员信息失败！');
}
...
<script type="text/javascript">
	...
	function form_check(){
		...
		if(admin_passwd_val!=''&&!my_regexp['password'].test(admin_passwd_val)){
...
<div class="content_main">
	...
	<div class="web_content">
		<div class="content_info">
			<form action="do.php?act=admin_edit" method="post" onsubmit="return form_check()" enctype="multipart/form-data">
				...
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="right_td">
							<select id="group_id" name="group_id">
								...
								<option value="<?php echo $val['group_id'];?>" <?php if($admin_arr['group_id']==$val['group_id']) echo 'selected';?>><?php echo $val['group_name'];?></option>
								<?php }?>
							</select>
					...
					<tr>
						...
						<td class="right_td">
							<input type="text" id="admin_name" name="admin_name" maxlength="18" value="<?php echo $admin_arr['admin_name'];?>" class="data_text"/>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="right_td">
							...
							<font class="tip_font">不做修改请留空</font>
						</td>
					</tr>
					<tr>
						<td class="left_td">邮箱：</td>
						<td class="right_td">
							<input type="text" id="email" name="email" value="<?php echo $admin_arr['email'];?>" class="data_text"/>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
