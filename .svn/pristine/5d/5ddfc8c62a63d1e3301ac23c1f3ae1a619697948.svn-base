...
<script type="text/javascript">
	...
	function form_check(){
		...
		if(site_logo_val==''){
			layer_tip(site_logo,'请选择网站logo！');
			return false;
		}
		if(!is_img(site_logo_val)){
...
<div class="content_main">
	...
	<div class="web_content">
		<div class="content_info">
			<form action="do.php?act=site_add" method="post" onsubmit="return form_check()" enctype="multipart/form-data">
				<input type="hidden" name="callback_url" value="<?php echo $callback_url;?>"/>
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td class="left_td">网站名称：</td>
						<td class="right_td">
							<input type="text" id="site_name" name="site_name" class="data_text"/>
					...
					<tr>
						...
						<td class="right_td">
							<input type="text" id="site_url" name="site_url" class="data_text" style="width:300px;"/>
							<font class="necessary">*</font>
					...
					<tr>
						...
						<td class="right_td">
							<label class="input_label"><input type="radio" name="is_available" value="1" checked="checked"/>支持</label>
							<label class="input_label"><input type="radio" name="is_available" value="0"/>不支持</label>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
