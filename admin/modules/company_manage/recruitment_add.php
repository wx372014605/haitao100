...
<div class="content_main">
	...
	<div class="web_content">
		<div class="content_info">
			<form action="do.php?act=recruitment_add" method="post" onsubmit="return form_check()" enctype="multipart/form-data">
				<input type="hidden" name="callback_url" value="<?php echo $callback_url;?>"/>
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td class="left_td">职位名称：</td>
						<td class="right_td">
							<input type="text" id="job_name" name="job_name" class="data_text"/>
					...
					<tr>
						...
						<td class="right_td">
							<input type="text" id="recruitment_num" name="recruitment_num" class="data_text" maxlength="4" style="width:50px;"/>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="right_td">
							<label class="input_label"><input type="radio" name="is_available" value="1" checked="checked"/>显示</label>
							<label class="input_label"><input type="radio" name="is_available" value="0"/>不显示</label>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="right_td">
							<script id="requirement_content" name="requirement_content" type="text/plain" style="width:800px;height:300px;"></script>
							<font class="necessary">*</font>
						</td>
					</tr>
					<tr>
