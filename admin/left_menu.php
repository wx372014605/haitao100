...
<div class="left_main">
	<div class="menu_list">
		<div class="parent_menu disable_select">微信管理</div>
		<ul class="sub_menu disable_select">
			<li><a href="modules.php?menu_tag=weixin_account_list" target="main_content">帐号设置</a></li>
			<li><a href="modules.php?menu_tag=weixin_user_info" target="main_content">用户信息</a></li>
			<li><a href="modules.php?menu_tag=weixin_mass_send" target="main_content">群发消息</a></li>
			<li><a href="modules.php?menu_tag=weixin_material_manage" target="main_content">素材管理</a></li>
		</ul>
	</div>
	<div class="menu_list">
		<div class="parent_menu disable_select">数据分析</div>
		<ul class="sub_menu disable_select">
			<li><a href="modules.php?menu_tag=weixin_user_analysis" target="main_content">用户分析</a></li>
		</ul>
	</div>
	<div class="menu_list">
