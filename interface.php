...
$act_arr = array(
	...
	"get_favorite_state"		=>	"interface/get_favorite_state.php",
	...
	"get_packageable_order"		=>	"interface/get_packageable_order.php",
	"order_package_submit"		=>	"interface/order_package_submit.php",
	...
	"get_site_class"			=>	"interface/get_site_class.php",
	"get_site_list"				=>	"interface/get_site_list.php",
	"get_site_info"				=>	"interface/get_site_info.php",
	"get_proxy_site_list"		=>	"interface/get_proxy_site_list.php",
	...
	"get_talk_history"			=>	"interface/get_talk_history.php",
	"get_transport_way"			=>	"interface/get_transport_way.php",
	"goods_eval_submit"			=>	"interface/goods_eval_submit.php",
	"get_goods_eval_level"		=>	"interface/get_goods_eval_level.php",
	"get_goods_eval_list"		=>	"interface/get_goods_eval_list.php",
	"get_goods_eval_top"		=>	"interface/get_goods_eval_top.php",
	"get_goods_eval_count"		=>	"interface/get_goods_eval_count.php",
);
